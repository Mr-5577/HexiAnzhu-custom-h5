<template>
	<view class="w-picker">
		<view class="mask" :class="{'show':showPicker}" @touchmove.stop.prevent catchtouchmove="true"></view>
		<view class="w-picker-cnt" :class="{'show':showPicker}">
			<view class="w-picker-hd" @touchmove.stop.prevent catchtouchmove="true" style="flex-direction: row;">
