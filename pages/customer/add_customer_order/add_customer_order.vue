<template>
	<view class="">
		<view v-if="showRoom">
			...
			<view class="margin-top">
				<form>
					...
					<view class="cu-form-group" style="padding-right: 18rpx;" @click="showRooms">
						<view class="title">选择房号</view>
						<view>
							<view class="picker flex">
								<text class="text-gray">{{ roomData.length == 0 ? demo : roomData.roomnum }}</text>
								<text class="text-gray cuIcon-right" style="font-size: 17px;"></text>
							</view>
						</view>
					</view>
					<!-- 房号信息数据 -->
					<template v-if="roomData.length != 0">
						...
						<view class="margin-top">
							<form>
								...
								<view class="bg-white  flex justify-center align-center">
									<view
										type="primary "
										class="margin-top margin-bottom  radius text-center text-blue"
										style="width: 80%;border: 1rpx solid #007AFF;height: 80rpx;line-height: 80rpx;"
										@click="showModal"
									>
										<text class="lg  cuIcon-text padding-right"></text>
										查看模板协议
									</view>
								</view>
							</form>
						...
						<view class="margin-top">
							<view class="padding">订单备注</view>
							<view class=" bg-white margin-sm">
								<textarea class="padding-sm radius" style="height: 100px;width: 100%;background:#EEEEEE;" placeholder="请输入订单备注" v-model="remark" />
							</view>
						</view>
						...
						<view class="margin-top">
							<view class=" bg-white">
								...
								<view class="flex radius margin-sm text-center" style="background:#EEEEEE; line-height: 80px;height: 80px; ">
									<text class="text-bold text-gray text-xxl padding-left" style="line-height: 80px;height: 80px;">￥</text>
						...
						<view class="margin-top margin-bottom-xxl">
							<button  class="margin cu-btn bg-blue round" style="width: 90%;height: 80rpx;line-height: 80rpx;" @click="sub">确定提交</button>
						</view>
					</template>
				</form>
			</view>
		...
		<view class="searchRoom" v-else>
			...
			<view class="" style="margin-top: 100rpx;padding-bottom: 140rpx;overflow: auto;">
			...
			<view class="foot">
				<button @click="close" class="cu-btn block bg-blue round margin-sm">
					关闭
				</button>
			</view>
		</view>
		...
		sub() {
			...
			this.$api.createBookingapi(data, res => {
				if (res.code == 1000) {
					...
					setTimeout(() => {
						uni.navigateTo({
							url: '/pages/customer/add_customer_order/success'
						});
					}, 1000);
				} else {
